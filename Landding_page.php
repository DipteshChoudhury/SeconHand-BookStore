            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                  ...
                  <p><a href="#" class="btn btn-warning mt3">Shop Now</a></p>
                </div>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
              <div class="about-text">
                ...
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Numquam reiciendis ipsum quae reprehenderit cumque distinctio. 
                  Maiores illum ut hic ratione nobis ducimus praesentium iusto blanditiis architecto exercitationem. 
                  Assumenda, vero libero.</p>
            ...
            <div class="card text-white text-center bg-dark pb-2">
              <div class="card-body">
                ...
                <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                  Quaerat ex repellat quod mollitia possimus dolores sint magnam dignissimos quae. 
                  Eveniet mollitia et modi architecto culpa.
                </p>
          ...
          <div class="col12 col-md-12 col-lg-4">
            <div class="card text-center bg-white pb-2">
              <div class="card-body text-dark">
                ...
                <p class="lead">[John Julius Norwich] remembered that there was a public composed of people who read books of history for pleasure,
                   not from duty</p>
          ...
          <div class="col12 col-md-12 col-lg-4">
            <div class="card text-center bg-white pb-2">
              <div class="card-body text-dark">
                ...
                <h3 class="card-title">Autobiography</h3>
                <p class="lead">The autobiography of West Indies fast-bowling legend turned Sky pundit, Michael Holding.</p>
                <button class="btn bg-warning text-dark">Learn More</button>
              </div>
            </div>
          </div>
          <div class="col12 col-md-12 col-lg-4">
            <div class="card text-center bg-white pb-2">
              <div class="card-body text-dark">
                ...
                <p class="lead">This handbook is the first volume to provide a comprehensive look at personality development. It features a state-of-the-art examination of the field,
        ...
        <div class="col-12 col-md-6 col-lg-2">
          <div class="card text-center">
            <div class="card-body">
              ...
              <h3 class="card-title py-2">Shibashis Mohapatra</h3>
              <p class="card-text">Student of IMCA. Front-end Web Developer using Html5,Css3,Php and JavaScript.</p>
              <p class="socials">
        ...
        <div class="col-12 col-md-6 col-lg-2">
          <div class="card text-center">
            <div class="card-body">
              ...
              <h3 class="card-title py-2">Sachikant Mohanty</h3>
              <p class="card-text">Student of IMCA. Front-end Web Developer using Html5,Css3,Php and JavaScript.</p>
              <p class="socials">
                <i class="fab fa-facebook-square fa-2x"></i>
                <i class="fab fa-instagram-square fa-2x"></i>
        ...
        <div class="col-12 col-md-6 col-lg-2">
          <div class="card text-center">
            <div class="card-body">
              ...
              <h3 class="card-title py-2">Safaly Padhi</h3>
              <p class="card-text">Student of IMCA. Back-end Web Developer using Mongotv.</p>
              <p class="socials">
                <i class="fab fa-facebook-square fa-2x"></i>
                <i class="fab fa-instagram-square fa-2x"></i>
                <i class="fab fa-twitter-square fa-2x"></i>
        ...
        <div class="col-12 col-md-6 col-lg-2">
          <div class="card text-center">
            <div class="card-body">
              ...
              <h3 class="card-title py-2">Diptesh Choudary</h3>
              <p class="card-text">Student of IMCA. Back-end Web Developer using MySql and phpMyadmin.</p>
              <p class="socials">
                <i class="fab fa-facebook-square fa-2x"></i>
                <i class="fab fa-instagram-square fa-2x"></i>
                <i class="fab fa-twitter-square fa-2x"></i>
        ...
        <div class="col-12 col-md-6 col-lg-2">
          <div class="card text-center">
            <div class="card-body">
              ...
              <h3 class="card-title py-2">Monali Priyadarshini Sahoo</h3>
              <p class="card-text">Student of IMCA. adipisicing elit.</p>
              <p class="socials">
                <i class="fab fa-facebook-square fa-2x"></i>
                <i class="fab fa-instagram-square fa-2x"></i>
                <i class="fab fa-twitter-square fa-2x"></i>
        ...
        <div class="col-12 col-md-6 col-lg-2">
          <div class="card text-center">
            <div class="card-body">
              ...
              <h3 class="card-title py-2">Sudipta Kar</h3>
              <p class="card-text">Student of IMCA. Lorem ipsum dolor sit amet.</p>
              <p class="socials">
                <i class="fab fa-facebook-square fa-2x"></i>
                <i class="fab fa-instagram-square fa-2x"></i>
                <i class="fab fa-twitter-square fa-2x"></i>
